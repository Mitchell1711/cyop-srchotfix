...
{
    secs = string_copy(secs, 2, string_length(secs))
    secs = concat("0", secs)
}
text = [[0, concat(lang_get_value("rank_highscore"), global.collect)], [0, concat(lang_get_value("rank_time"), mins, ":", secs)], [0, concat(lang_get_value("rank_damage"), global.player_damage)], [0, concat(lang_get_value("rank_combo"), global.highest_combo)]]
text_pos = 0
toppin_index = 0
